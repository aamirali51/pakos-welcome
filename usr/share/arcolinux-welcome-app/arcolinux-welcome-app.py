...
class Main(Gtk.Window):
    def __init__(self):
        super(Main, self).__init__(title="pakosLinux Welcome App")
        self.set_border_width(10)
        self.set_default_size(860, 250)
        self.set_icon_from_file(os.path.join(
            GUI.base_dir, 'images/pakoslinux.png'))
        self.set_position(Gtk.WindowPosition.CENTER)
        self.results = ""
        if not os.path.exists(GUI.home + "/.config/pakoslinux-welcome-app/"):
            os.mkdir(GUI.home + "/.config/pakoslinux-welcome-app/")
    ...
    def on_launch_clicked(self, widget, event, link):
        if os.path.isfile("/usr/bin/archlinux-tweak-tool"):
            ...
            md.format_secondary_markup(
                "<b>pakosLinux Tweak Tool</b> was not found on your system\n\
Do you want to install it?")
    ...
    def installATT(self):
        ...
        GLib.idle_add(self.MessageBox,
                      "Success!",
                      "<b>pakosLinux Tweak Tool</b> has been installed successfully")  # noqa
