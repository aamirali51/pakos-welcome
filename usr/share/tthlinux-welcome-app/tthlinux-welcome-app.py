...
class Main(Gtk.Window):
    def __init__(self):
        super(Main, self).__init__(title="tthlinux Welcome App")
        self.set_border_width(10)
        self.set_default_size(860, 250)
        self.set_icon_from_file(os.path.join(base_dir, "images/tthlinux.png"))
        self.set_position(Gtk.WindowPosition.CENTER)
        self.results = ""

        if not os.path.exists(GUI.home + "/.config/tthlinux-welcome-app/"):
            os.mkdir(GUI.home + "/.config/tthlinux-welcome-app/")
    ...
    def installATT(self):
        ...
        GLib.idle_add(
            self.MessageBox,
            "Success!",
            "<b>tthlinux Tweak Tool</b> has been installed successfully",
        )  # noqa
