...
app_website = "https://tthlinux.info"
app_forums = "https://www.tthlinuxforum.com"
app_telegram = "https://t.me/tthlinux_d_b"
...
Settings = home + "/.config/tthlinux-welcome-app/settings.conf"
Skel_Settings = "/etc/skel/.config/tthlinux-welcome-app/settings.conf"
dot_desktop = "/usr/share/applications/tthlinux-welcome-app.desktop"
autostart = home + "/.config/autostart/tthlinux-welcome-app.desktop"
...
def GUI(self, Gtk, GdkPixbuf):
    ...
    headerbar.set_title("TTH-LINUX Welcome App")
            ...
            headerbar.pack_start(
                Gtk.Image().new_from_pixbuf(
                    GdkPixbuf.Pixbuf().new_from_file_at_size(
                        os.path.join(base_dir, "images/tthlinux.png"), 16, 16
                    )
                )
            )
    ...
    fb_event.connect(
        ...
        "https://www.facebook.com/groups/tthlinux",
    )
    ...
    insta_event.connect(
        "button_press_event",
        self.on_social_clicked,
        "https://www.instagram.com/tthlinux/",
    )
    ...
    lin_event.connect(
        "button_press_event",
        self.on_social_clicked,
        "https://www.linkedin.com/in/tthlinux/",
    )
    ...
    pat_event.connect(
        "button_press_event",
        self.on_social_clicked,
        "https://www.patreon.com/tthlinux",
    )
    ...
    if debug is True:
        label_info_header1.set_markup("<b>tthlinux Installer</b>")
        ...
        label_info_header1.set_markup("<b>Welcome to tthlinux</b>")
        desc = (
            f"We communicate with our community via a diversity of social media.\n"
            f"Do join us to learn the latest news, ask questions or for casual talk.\n"
            f"Join us <b> <a href='{app_youtube}' title='{app_youtube}'>Youtube</a></b> as we communicate and teach via our Youtube channel.\n"
    ...
    # label_welcome.set_markup("<big>Welcome to <b>tthlinux</b></big>")
    ...
    pixbuf = GdkPixbuf.Pixbuf().new_from_file_at_size(
        os.path.join(base_dir, "images/tthlinux-one-liner.png"), 164, 164
    )
    ...
    if username == user:
        ...
        label_welcome_message.set_text(
            "The buttons below will help you get started on tthlinux"
        )
    ...
    if username == user:
        ...
        # self.button_arco_website.get_child().set_markup("<b>tthlinux Website</b>")
    ...
    check.connect(
        ...
        "Autostart tthlinux Welcome App at login",
    )
