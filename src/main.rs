...
fn show_about_dialog() {
    ...
    let dialog = gtk::AboutDialog::builder()
        ...
        .modal(true)
        .program_name(&gettextrs::gettext("pakosLinux Welcome"))
        .comments(&gettextrs::gettext("Welcome screen for pakosLinux"))
        .version(VERSION)
        .logo(&logo)
        .authors(vec![
...
fn main() {
    ...
    glib::set_application_name("pakosLinuxHello");
...
fn build_ui(application: &gtk::Application) {
    ...
    header.set_subtitle(Some("pakosLinux rolling"));
